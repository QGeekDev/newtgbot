...
const { buttonContinue, buttonSendInfo, buttonChangeInfo } = require('./options');
// Token
...
const botMenu = new Bot(token);

botMenu.api.setMyCommands([
...
function sendConfirmInfo(chatId, name) {
	bot.sendMessage(chatId, `${name}, you chose:
